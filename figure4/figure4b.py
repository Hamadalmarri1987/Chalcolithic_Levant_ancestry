...
def compute_dominance_ranges(
    ...
    f = df[(df[p_col] >= p_min) & (df[p_col] <= p_max)].copy()
...
def main():
    ...
    out_png = "dominance_ranges_p090_0999_se008.png"
    out_csv = "filtered_models_p090_0999_se008.csv"
    ...
    title = f"Dominant ancestry ranges (p={p_min}–{p_max}, all SE ≤ {se_max})"
